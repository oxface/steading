...
- **Gate on manifests**: draft YAML freely only for graduated concepts; for non-graduated ones, outline the structure and let the user write it (rep 1 guided, rep 2+ cold review).
